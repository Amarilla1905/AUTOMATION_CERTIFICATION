...
public class TestPlanPage {
    ...
    public static final Target TXT_NUMBER_TP = Target.the("Text with number of tp ").locatedBy("//div[@class='flex-row body-xl padding-bottom-4 padding-right-8 flex-center']");
